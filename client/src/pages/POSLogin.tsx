      ...
      <Card className="w-full max-w-md bg-slate-800/90 border-slate-700 backdrop-blur-sm shadow-2xl relative z-10">
        <CardHeader className="text-center space-y-4 pb-2">
          ...
          <div className="flex justify-center">
            <div className="w-24 h-24 bg-gradient-to-br from-primary/20 to-primary/40 rounded-2xl flex items-center justify-center shadow-lg shadow-primary/20 border-2 border-primary/30 overflow-hidden">
              <img 
                src="/logo.png" 
                alt="Symbol AI" 
                ...
                onError={(e) => {
                  ...
                  (e.target as HTMLImageElement).parentElement!.innerHTML = '<svg class="w-12 h-12 text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>';
                }}
              />
            </div>
          </div>
