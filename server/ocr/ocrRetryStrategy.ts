...
مهم جداً: الإيصال يحتوي على تاريخين:
1. تاريخ الموازنة (في أعلى الإيصال، بعد اسم المحل) - هذا هو التاريخ المطلوب
2. تاريخ الطباعة (في أسفل الإيصال، قبل "شكرا لاستخدامكم مدى") - تجاهل هذا`,
  userPrompt: `اقرأ هذا الإيصال واستخرج:
1. تاريخ الموازنة (YYYY-MM-DD) - التاريخ الأول في أعلى الإيصال (ليس تاريخ الطباعة في الأسفل)
...
- التاريخ الأول في أعلى الإيصال (بعد اسم المحل مباشرة)
...
مهم: التاريخ المطلوب هو تاريخ الموازنة (الأول في أعلى الإيصال)، ليس تاريخ الطباعة (في الأسفل).`,
...
3. التاريخ: استخرج التاريخ الأول في أعلى الإيصال (تاريخ الموازنة)، تجاهل التاريخ في الأسفل
...
مهم جداً: الإيصال يحتوي على تاريخين مختلفين:
- تاريخ الموازنة (في الأعلى، بعد اسم المحل) - هذا هو المطلوب
- تاريخ الطباعة (في الأسفل، قبل "شكرا لاستخدامكم") - تجاهل هذا`,
...
2. إذا كان إيصال POS، ابحث عن:
   - تاريخ الموازنة (التاريخ الأول في أعلى الإيصال، بعد اسم المحل)
...
3. تجاهل التاريخ في أسفل الإيصال (تاريخ الطباعة)
...
ملاحظة: التاريخ المطلوب هو الأول في أعلى الإيصال (تاريخ الموازنة)، ليس التاريخ في الأسفل.`,
  userPrompt: `ابحث عن المجموع الكلي وتاريخ الموازنة في هذا الإيصال.

ابحث عن:
- GRAND TOTAL
- TOTAL AMOUNT
- المجموع الكلي
- التاريخ الأول في أعلى الإيصال (بعد اسم المحل)
