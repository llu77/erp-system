...
- [ ] تحليل عميق للمشكلة وفحص السجلات
...
- [ ] إصلاح كود رفع الصورة في صفحة التسجيل
...
- [ ] فلترة الزيارات حسب فرع المشرف
- [ ] فلترة التقارير حسب فرع المشرف
- [ ] إضافة API قبول الزيارة
- [ ] إضافة API رفض الزيارة
- [ ] السماح للأدمن برؤية جميع الفروع

### تعديل الواجهة
- [ ] إخفاء فلتر الفروع للمشرفين (يرون فرعهم فقط)
- [ ] عرض اسم الفرع في العنوان للمشرفين
- [ ] إضافة أزرار قبول/رفض للزيارات المعلقة
- [ ] تعديل صفحة التسجيل لاستخدام فرع المشرف تلقائياً
- [ ] تعديل صفحة تسجيل الزيارة لاستخدام فرع المشرف تلقائياً
...
- [ ] تحسين قالب تقرير المصاريف (رسوم بيانية، تخطيط محسّن)
- [ ] تحسين قالب تقرير الرواتب (جداول منظمة، إحصائيات)
- [ ] إضافة رسوم بيانية للتقارير (مخططات بيانية)
