...
## تحسين الاستجابة للموبايل - 30 يناير 2026

### 1. CSS العام (index.css)
- [x] إضافة media queries للشاشات الصغيرة (480px, 640px, 768px)
- [x] تقليل padding و margins على الموبايل
- [x] تصغير أحجام الخطوط على الموبايل
- [x] تحسين أحجام الأيقونات على الموبايل
- [x] إضافة تحسينات Touch devices
- [x] إضافة فئات mobile-only و desktop-only
- [x] تحسين الطباعة @media print

### 2. لوحة التحكم الرئيسية (Dashboard.tsx)
- [x] تحسين grid بطاقات الإحصائيات للموبايل (2 أعمدة)
- [x] تصغير بطاقات الإحصائيات على الموبايل (padding, icons, fonts)
- [x] تحسين تنبيه نفاد المخزون للموبايل (flex-col, أحجام أصغر)
- [x] تحسين قوائم الفواتير وأوامر الشراء للموبايل (h-200px, أحجام أصغر)

### 3. القائمة الجانبية (DashboardLayout.tsx)
...
## تحسين صفحات الجداول للموبايل - 30 يناير 2026

### 1. مكون MobileCardView
- [x] إنشاء مكون MobileCard و MobileCardList قابل لإعادة الاستخدام
- [x] دعم عرض البيانات كبطاقات على الموبايل مع fields مخصصة
- [x] دعم الإجراءات (تعديل، حذف، عرض) عبر DropdownMenu
- [x] تصميم متجاوب مع الوضع الداكن
- [x] إضافة useResponsiveView hook للتبديل التلقائي
- [x] دعم statusBadge و isTitle/isSubtitle/isPrice/isHighlighted

### 2. صفحة المنتجات (Products.tsx)
- [x] إخفاء الأعمدة غير الضرورية على الموبايل (الفئة، سعر التكلفة، الحالة)
- [x] إضافة عرض البطاقات للمنتجات على الموبايل
- [x] تحسين أزرار الإجراءات للموبايل عبر DropdownMenu

### 3. صفحة الفواتير (Invoices.tsx)
- [x] إخفاء الأعمدة غير الضرورية على الموبايل (التاريخ)
- [x] إضافة عرض البطاقات للفواتير على الموبايل
- [x] تحسين عرض المبالغ والتواريخ والحالة

### 4. صفحة العملاء (Customers.tsx)
- [x] إخفاء الأعمدة غير الضرورية على الموبايل (البريد، المدينة)
- [x] إضافة عرض البطاقات للعملاء على الموبايل
- [x] تحسين عرض معلومات الاتصال (هاتف، بريد)


## تحسينات القائمة الجانبية والتصميم العام - 30 يناير 2026

### 1. إصلاح القائمة الجانبية
- [x] إغلاق القائمة تلقائياً عند الضغط على صفحة في الموبايل (navigateTo function)
- [x] تكبير الشعار الرسمي للبرنامج (h-14 w-14)
- [x] تحسين تصميم عناصر القائمة

### 2. تحسين تدرج الألوان والتصميم الرسمي
- [x] تحسين تدرجات الألوان للوضع الداكن (background, card, muted)
- [x] إضافة تأثيرات احترافية للبطاقات (kpi-card, kpi-icon, kpi-value, kpi-label)
- [x] تحسين التباين والوضوح (card-professional, table-professional)
- [x] إضافة تأثيرات hover متقدمة

### 3. تحسين صفحة الإيرادات
- [x] تحسين تصميم البطاقات والجداول (kpi-card, table-professional)
- [x] إضافة تأثيرات hover متقدمة
- [x] تحسين عرض الأرقام والإحصائيات (kpi-value, kpi-label)

### 4. تحسين صفحة المصروفات
- [x] تحسين تصميم البطاقات والجداول (kpi-card)
- [x] إضافة تأثيرات hover متقدمة
- [x] تحسين عرض الأرقام والإحصائيات (kpi-value, kpi-label)

### 5. تحسين صفحة الطلبات
- [x] تحسين تصميم البطاقات والجداول (kpi-card)
- [x] إضافة تأثيرات hover متقدمة
- [x] تحسين عرض حالات الطلبات (card-professional)

### 6. تحسين اللوحة التنفيذية
...
## مساعد التقارير الذكي (AI Report Assistant) - 30 يناير 2026

### 1. تصميم البنية والمتطلبات
- [ ] تحديد أنواع الأسئلة المدعومة (مبيعات، مخزون، موظفين، عملاء، مالية)
- [ ] تحديد أنواع التقارير (جدول، رسم بياني، ملخص، مقارنة)
- [ ] تصميم هيكل البيانات للمحادثات والتقارير

### 2. Backend API
- [ ] إنشاء جدول ai_report_conversations لحفظ المحادثات
- [ ] إنشاء جدول ai_report_history لحفظ التقارير المولدة
- [ ] إنشاء tRPC endpoints للمحادثة والتقارير

### 3. خدمة تحليل الأسئلة بالذكاء الاصطناعي
- [ ] إنشاء reportAnalyzerService.ts لتحليل الأسئلة العربية
- [ ] تحويل الأسئلة إلى استعلامات قاعدة بيانات
- [ ] دعم الأسئلة المعقدة (مقارنات، فترات زمنية، فلاتر)

### 4. خدمة توليد التقارير
- [ ] إنشاء reportGeneratorService.ts لتوليد التقارير
- [ ] دعم أنواع متعددة من التقارير (جدول، رسم بياني، ملخص)
- [ ] توليد تحليلات ذكية وتوصيات

### 5. واجهة المحادثة الذكية
- [ ] إنشاء صفحة AIReportAssistant.tsx
- [ ] تصميم واجهة محادثة احترافية
- [ ] عرض التقارير داخل المحادثة
- [ ] دعم الأسئلة المتتابعة والسياق

### 6. الرسوم البيانية والتصدير
...
## مساعد التقارير الذكي - Nawab AI (مكتمل)
- [x] إنشاء خدمة تحليل الأسئلة بالذكاء الاصطناعي
- [x] إنشاء خدمة توليد التقارير التلقائية
- [x] دعم 13 نوع تقرير مختلف
- [x] دعم 7 أنواع رسوم بيانية
- [x] واجهة محادثة ذكية بالعربية
- [x] أسئلة مقترحة للمستخدم
- [x] تحليلات وتوصيات ذكية
- [x] مكون الرسوم البيانية (ReportChart)
- [x] إضافة المسار في App.tsx
- [x] إضافة الرابط في القائمة الجانبية
- [x] اختبارات vitest (7 اختبارات ناجحة)


## تطوير شامل للذكاء الاصطناعي - المرحلة المتقدمة

### 1. نظام الأدوات الذكية المتكامل (AI Tools Hub)
- [x] مركز أدوات موحد يجمع كل قدرات الذكاء الاصطناعي
- [x] أداة تحليل المبيعات الذكية (Sales Intelligence)
- [x] أداة تحليل سلوك العملاء (Customer Behavior Analysis)
- [x] أداة التنبؤ بالطلب (Demand Forecasting)
- [ ] أداة تحسين الأسعار الديناميكية (Dynamic Pricing)
- [x] أداة كشف الاحتيال (Fraud Detection)
- [ ] أداة تحليل أداء الموظفين (Employee Performance AI)
- [ ] أداة تحسين المخزون (Inventory Optimization)

### 2. نظام الصلاحيات الذكي (Smart Permissions)
- [x] صلاحيات ديناميكية تتكيف مع السياق
- [x] تصعيد تلقائي للصلاحيات في الحالات الطارئة
- [x] قيود ذكية بناءً على الوقت والموقع
- [x] تتبع وتدقيق استخدام الصلاحيات بالذكاء الاصطناعي
- [x] اكتشاف الأنماط غير الطبيعية في استخدام الصلاحيات

### 3. محرك التوصيات المتقدم (Advanced Recommendation Engine)
- [x] توصيات مخصصة لكل مستخدم
- [x] تحليل سياقي للتوصيات
- [ ] تعلم من تفاعلات المستخدم
- [x] توصيات استباقية قبل حدوث المشاكل
- [ ] تقييم تأثير التوصيات المطبقة

### 4. نظام التنبؤات المالية المتقدم (Financial Forecasting)
- [ ] تنبؤ متعدد السيناريوهات
- [ ] تحليل الحساسية للمتغيرات
- [ ] نماذج تنبؤ موسمية
- [ ] تكامل مع العوامل الخارجية (اقتصاد، طقس، مناسبات)

### 5. مساعد الذكاء الاصطناعي الشامل (AI Command Center)
- [x] واجهة موحدة للتحكم بكل أدوات الذكاء الاصطناعي
- [x] تنفيذ أوامر معقدة بالمحادثة
- [x] تكامل مع جميع وحدات النظام
- [x] سجل محادثات ذكي مع تعلم مستمر

### 6. نظام الأتمتة الذكية (Smart Automation)
- [ ] أتمتة المهام المتكررة
- [ ] سير عمل ذكي يتكيف مع الظروف
- [ ] جدولة ذكية للمهام
- [ ] تنبيهات استباقية


### 6. واجهات المستخدم المتقدمة
- [x] واجهة مركز التحكم بالذكاء الاصطناعي (AICommandCenter)
- [x] لوحة التوصيات الذكية مع الأولويات
- [x] عرض الأدوات المتاحة بشكل تفاعلي
- [x] تكامل مع القائمة الجانبية

### 7. الاختبارات
- [x] اختبارات مركز أدوات الذكاء الاصطناعي (aiToolsHub.test.ts)
- [x] اختبارات محرك التوصيات المتقدم (advancedRecommendationEngine.test.ts)
- [x] جميع الاختبارات (881) نجحت بنجاح


## تكامل التوصيات الذكية مع نظام الإشعارات

### 1. خدمة إشعارات التوصيات
- [x] إنشاء خدمة AIRecommendationNotifier
- [x] تصنيف التوصيات حسب الأولوية (critical, high, medium, low)
- [x] تحديد المستلمين حسب نوع التوصية والصلاحيات
- [x] دعم قنوات متعددة (in-app, email, owner)

### 2. نظام المراقبة التلقائية
- [x] إنشاء نظام مراقبة دوري AIRecommendationMonitor
- [x] اكتشاف الأنماط العاجلة تلقائياً
- [x] إرسال تنبيهات فورية للمدراء
- [x] تتبع حالة التوصيات المرسلة

### 3. واجهة المستخدم
- [x] صفحة إعدادات المراقبة الذكية
- [x] لوحة تحكم بالمراقبة (بدء/إيقاف)
- [x] سجل دورات المراقبة

### 4. الاختبارات
- [x] اختبارات خدمة الإشعارات
- [x] اختبارات نظام المراقبة


## تحسين نموذج سند القبض

### 1. حقول التاريخ
- [ ] إضافة حقل تاريخ "من" بالتاريخ الميلادي
- [ ] إضافة حقل تاريخ "إلى" بالتاريخ الميلادي
- [ ] تنسيق التاريخ بشكل احترافي

### 2. تحسين الطباعة
- [ ] تحسين تصميم نموذج الطباعة
- [ ] إضافة الشعار والختم
- [ ] تحسين الخطوط والألوان
- [ ] إضافة التوقيعات الرسمية
...
## تحسين نموذج سند القبض (مكتمل)

### 1. حقول التاريخ
- [x] إضافة حقل "من تاريخ" (dueDateFrom)
- [x] إضافة حقل "إلى تاريخ" (dueDateTo)
- [x] عرض التواريخ بالتنسيق الميلادي (DD/MM/YYYY)

### 2. تحسين الطباعة
- [x] تحسين تصميم نموذج الطباعة
- [x] إضافة الشعار والختم
- [x] تكبير التوقيعات

### 3. تصدير PDF
- [x] تمكين تصدير السند إلى PDF
- [x] تحسين جودة PDF


## إضافة حالة الاعتماد لسند القبض

### 1. سير عمل الاعتماد
- [ ] إضافة زر اعتماد السند للمدير
- [ ] تحديث حالة السند إلى "معتمد" عند الموافقة
- [ ] حفظ بيانات المعتمد (الاسم، التاريخ)

### 2. تحديث PDF
- [ ] عرض ختم "معتمد" في PDF للسندات المعتمدة فقط
- [ ] إضافة تاريخ واسم المعتمد في PDF
- [ ] تعطيل الطباعة للسندات غير المعتمدة (اختياري)


## إضافة قائمة اختيار العميل في صفحة الإيرادات (مكتمل)

### المتطلبات
- [x] إضافة قائمة منسدلة لاختيار اسم العميل عند إدخال فاتورة مدفوع
- [x] العملاء المتاحون: عمر المطيري، سالم الوادعي، سعود الحريسي
- [x] إظهار القائمة فقط عند إدخال قيمة في حقل فاتورة مدفوع
- [x] حفظ اسم العميل مع بيانات الإيراد


## إضافة عمود ولاء في صفحة الإيرادات (مكتمل)

### المتطلبات
- [x] إضافة حقل "ولاء" لإدخال مبلغ الولاء
- [x] إلزامية رفع فاتورة ولاء عند إدخال مبلغ
- [x] تحديث قاعدة البيانات لتخزين مبلغ الولاء وصورة الفاتورة
- [x] تحديث الخادم لمعالجة البيانات الجديدة
- [x] عرض عمود الولاء في جدول الإيرادات الشهرية
- [x] إضافة أيقونة لعرض صورة فاتورة الولاء


## إضافة الولاء في حساب الإجمالي (مكتمل)
...
## تحسينات الإيرادات - عرض تفصيل الإجمالي والولاء (مكتمل)
...
## نظام التحقق من صحة البيانات المالية (Server-Side Validation)

### المتطلبات
- [ ] إنشاء خدمة تحقق مركزية (ValidationService)
- [ ] التحقق من المبالغ (أرقام موجبة، حدود قصوى/دنيا)
- [ ] التحقق من التواريخ (تواريخ صالحة، لا مستقبلية)
- [ ] التحقق من العلاقات (وجود الفرع، العميل، الموظف)
- [ ] رسائل خطأ واضحة بالعربية
- [ ] تطبيق التحقق على الإيرادات والمصروفات والفواتير
- [ ] كتابة اختبارات للتحقق

## التحقق من صحة البيانات المالية على مستوى الخادم (طلب جديد)
- [x] إنشاء خدمة التحقق المركزية (financialValidation.ts)
- [x] التحقق من صحة المبالغ (validateAmount)
- [x] التحقق من صحة التواريخ (validateDate)
- [x] التحقق من صحة النصوص (validateText)
- [x] التحقق من وجود الفرع (validateBranchExists)
- [x] التحقق من وجود الموظف (validateEmployeeExists)
- [x] التحقق من وجود العميل (validateCustomerExists)
- [x] تطبيق التحقق على router الإيرادات (revenues.createDaily)
- [x] تطبيق التحقق على router المصروفات (expenses.create)
- [x] التحقق من إلزامية صورة فاتورة الولاء عند إدخال مبلغ ولاء
- [x] التحقق من إلزامية اسم العميل عند إدخال فواتير مدفوع
- [x] التحقق من صحة إيرادات الموظفين
- [x] كتابة اختبارات vitest شاملة (47 اختبار ناجح)
- [x] حدود المبالغ: الحد الأقصى 10 مليون ريال، خانتين عشريتين
- [x] حدود التواريخ: 30 يوم في الماضي للإيرادات، 90 يوم للمصروفات
- [x] رسائل خطأ واضحة باللغة العربية


## 🔧 حل مشكلة عدم ظهور صور الموازنة (Deep Thinking Framework)
- [ ] Phase 1: تحليل المشكلة - فهم سبب عدم ظهور الصور
- [ ] Phase 2: تصميم الحل - آلية تجديد روابط S3 المنتهية
- [ ] Phase 3: خطة التنفيذ - تحديد الملفات والتعديلات المطلوبة
- [ ] Phase 4: التنفيذ - كتابة الكود وتطبيق الحل
- [ ] Phase 5: الاختبار - التحقق من عمل الصور بشكل صحيح


## إصلاح عرض صور الموازنة - روابط S3 المنتهية (طلب جديد)
- [x] تحليل المشكلة: روابط S3 presigned تنتهي بعد ساعة
- [x] إنشاء مكون S3Image للتجديد التلقائي للروابط
- [x] إضافة endpoint refreshImageUrl في routers.ts
- [x] إضافة endpoint batchRefreshImageUrls للتجديد الدفعي
...
## إصلاح صور الفواتير في صفحة الولاء (طلب جديد)
- [ ] تحليل صفحة الولاء وتحديد مواقع عرض الصور
- [ ] تطبيق S3Image على modal صورة الفاتورة
- [ ] اختبار والتسليم

## إضافة عمود الفرع في صفحة المشتريات (طلب جديد)
- [x] تحليل صفحة المشتريات والبيانات المتاحة
- [x] إضافة عمود الفرع في الجدول (join مع جدول branches)
- [x] اختبار وتسليم (967 اختبار ناجح)

## إصلاح مشكلة طباعة السندات وتقرير السندات (طلب جديد)
- [ ] تحليل صفحة السندات وتحديد المشكلة
- [ ] إصلاح طباعة السند الفردي
- [ ] إصلاح/إضافة تقرير السندات
- [ ] اختبار وتسليم


## إصلاح مشكلة طباعة السندات وتقرير السندات (طلب جديد)
- [x] تحليل صفحة السندات وتحديد المشكلة
- [x] إضافة زر تحميل PDF مباشر في جدول السندات
- [x] إضافة زر "تقرير السندات" في رأس الصفحة
- [x] اختبار وتسليم (967 اختبار ناجح)


## إضافة أزرار الإجراءات في صفحة تقارير السندات (طلب جديد)
- [ ] تحليل صفحة تقارير السندات
- [ ] إضافة عمود الإجراءات (معاينة، اعتماد، طباعة PDF)
- [ ] اختبار وتسليم


## إضافة أزرار الإجراءات في صفحة تقارير السندات (مكتمل)
- [x] تحليل صفحة تقارير السندات
- [x] إضافة عمود الإجراءات (معاينة، اعتماد، طباعة PDF)
- [x] إضافة dialog معاينة السند مع تفاصيل كاملة
- [x] اختبار وتسليم (967 اختبار ناجح)


## بوابة الكاشير - نظام POS للصالونات (طلب جديد)

### Phase 1: Understand - الفهم العميق
- [x] تحليل المتطلبات الصريحة والضمنية
- [x] تحديد الحالات الحدية (Edge Cases)

### Phase 2: Architect - تصميم قاعدة البيانات
- [ ] تصميم جدول الأقسام (posCategories)
- [ ] تصميم جدول الخدمات (posServices)
- [ ] تصميم جدول الفواتير (posInvoices)
- [ ] تصميم جدول تفاصيل الفواتير (posInvoiceItems)
- [ ] تصميم جدول مستخدمي الكاشير (posCashiers)

### Phase 3: Plan & Implement - Backend
- [ ] إنشاء Schema في Drizzle
- [ ] إنشاء tRPC Router للكاشير
- [ ] ربط مع نظام الولاء الحالي
- [ ] إنشاء منطق حساب الفواتير

### Phase 4: Implement - الواجهة الرئيسية
- [ ] صفحة تسجيل دخول الكاشير
- [ ] صفحة الأقسام والخدمات
- [ ] صفحة إنشاء الفاتورة (اختيار موظف + خدمات + دفع)
- [ ] صفحة الفروع والموظفين

### Phase 5: Implement - التقارير والطباعة
- [ ] صفحة تقرير اليوم
- [ ] قالب الفاتورة الحرارية
- [ ] طباعة متوافقة مع Chrome

### Phase 6: Review - الاختبار والتسليم
- [ ] اختبارات Vitest
- [ ] اختبار شامل للنظام
- [ ] تسليم وحفظ Checkpoint


## بوابة الكاشير - نظام POS (مكتمل)

### قاعدة البيانات
- [x] جدول أقسام الخدمات (posCategories)
- [x] جدول الخدمات (posServices)
- [x] جدول الفواتير (posInvoices)
- [x] جدول بنود الفواتير (posInvoiceItems)
- [x] جدول ملخص اليوم (posDailySummary)
- [x] جدول أداء الموظفين (posEmployeePerformance)

### الـ Backend (API)
- [x] إدارة الأقسام (CRUD)
- [x] إدارة الخدمات (CRUD)
- [x] إنشاء الفواتير
- [x] جلب فواتير اليوم
- [x] جلب موظفي الفرع
- [x] البحث في عملاء الولاء
- [x] التحقق من خصم الولاء

### الواجهة الرئيسية (POS.tsx)
- [x] اختيار الفرع والموظف
- [x] عرض الأقسام والخدمات
- [x] سلة المشتريات (إضافة/حذف/تعديل الكمية)
- [x] طرق الدفع (كاش، شبكة، تقسيم، ولاء)
- [x] ربط مع نظام الولاء
- [x] الساعة الحية (24 ساعة)
- [x] طباعة فاتورة حرارية (80mm)

### تقرير اليوم (POSDailyReport.tsx)
- [x] إجمالي الفواتير
- [x] إجمالي الإيرادات
- [x] إجمالي الكاش
- [x] إجمالي الشبكة
- [x] أداء الموظفين (عدد الفواتير + الإيرادات)
- [x] قائمة فواتير اليوم

### إعدادات الكاشير (POSSettings.tsx)
- [x] إدارة الأقسام (إضافة/تعديل/حذف)
- [x] إدارة الخدمات (إضافة/تعديل/حذف)

### الطباعة الحرارية
- [x] قالب فاتورة 80mm
- [x] معلومات الفرع والموظف
- [x] تفاصيل الخدمات
- [x] الإجمالي والخصم
- [x] طريقة الدفع
- [x] متوافق مع Google Chrome

### الاختبارات
- [x] 967 اختبار ناجح


## تحسين واجهة بوابة الكاشير (طلب جديد)

### Phase 1: التحليل والتخطيط
- [ ] تحليل الواجهة الحالية وتحديد نقاط التحسين
- [ ] تصميم layout مُحسّن لشاشات الكمبيوتر الكبيرة
- [ ] تصميم layout مُحسّن لأجهزة الكاشير (شاشات اللمس)

### Phase 2: تحسين واجهة الكاشير الرئيسية
- [ ] إضافة الشعار في رأس الصفحة
- [ ] تحسين تخطيط الشاشة لاستغلال المساحة الكاملة
- [ ] تكبير أزرار الخدمات لسهولة اللمس
- [ ] تحسين سلة المشتريات لتكون واضحة ومرئية
- [ ] تحسين قسم الدفع والإجمالي
- [ ] إضافة اختصارات لوحة المفاتيح

### Phase 3: تحسين تقرير اليوم والإعدادات
- [ ] تحسين تخطيط تقرير اليوم
- [ ] تحسين صفحة الإعدادات
- [ ] إضافة الشعار في جميع الصفحات

### Phase 4: التحسين النهائي
- [ ] اختبار على شاشات مختلفة
- [ ] تحسين الأداء
- [ ] اختبارات vitest


## تحسين واجهة بوابة الكاشير للشاشات الكبيرة (طلب جديد - مكتمل)

### واجهة الكاشير الرئيسية (POS.tsx)
- [x] إضافة الشعار في رأس الصفحة
- [x] ساعة كبيرة وبارزة مع التاريخ
- [x] تخطيط ملء الشاشة بدون DashboardLayout
- [x] أزرار الخدمات كبيرة (min-height: 140px) لسهولة اللمس
- [x] أقسام الخدمات أفقية قابلة للتمرير
- [x] سلة مشتريات ثابتة على اليمين (420px)
- [x] اختصارات لوحة المفاتيح (F2, F3, F4)
- [x] أزرار طرق الدفع كبيرة (h-20)
- [x] طباعة فاتورة حرارية 80mm

### صفحة تقرير اليوم (POSDailyReport.tsx)
- [x] تخطيط ملء الشاشة
- [x] إضافة الشعار
- [x] بطاقات إحصائية كبيرة
- [x] جدول أداء الموظفين
- [x] جدول فواتير اليوم

### صفحة الإعدادات (POSSettings.tsx)
- [x] تخطيط ملء الشاشة
- [x] إضافة الشعار
- [x] إدارة الأقسام والخدمات
...
## صلاحيات بوابة الكاشير (مكتمل)
- [x] إنشاء صفحة تسجيل دخول منفصلة لبوابة الكاشير (/pos/login)
- [x] الأدمن: رؤية جميع الفروع (لبن + طويق)
- [x] مشرف لبن (عبدالحي): فرع لبن فقط (اختيار تلقائي)
- [x] مشرف طويق (محمد إسماعيل): فرع طويق فقط (اختيار تلقائي)
- [x] تقييد اختيار الفرع حسب صلاحيات المستخدم
- [x] اختبار وتسليم (967 اختبار ناجح)


## ربط فواتير الكاشير بالإيرادات (طلب جديد)
- [x] Phase 1: تصميم نظام الربط والتأكيد
  - [x] إنشاء دوال قاعدة البيانات (checkPosConfirmationStatus, createRevenueFromPOS, markPosInvoicesAsConfirmed)
  - [x] إنشاء API endpoints (تأكيد، إرسال، عملاء المدفوع)
  - [x] ربط مع جدول dailyRevenues الموجود
  - [x] 12 اختبار جديد للتأكيد
- [ ] Phase 2: إضافة واجهة التأكيد في تقرير اليوم
  - [ ] زر تأكيد يومي لإرسال الفواتير للإيرادات
  - [ ] صورة الموازنة إجبارية عند التأكيد
  - [ ] فواتير المدفوع اختيارية مع اختيار العميل (سالم الوادعي، عمر المطيري، سعود الجريسي)
  - [ ] فواتير الولاء مع قيمة الخصم وعدد الفواتير
- [ ] Phase 3: ربط الفواتير بالإيرادات تلقائياً
- [ ] Phase 4: اختبار وتسليم


## إضافة رابط بوابة الكاشير في صفحة تسجيل الدخول (مكتمل)
- [x] إضافة زر بوابة الكاشير بجانب زر بوابة الموظفين
- [x] تصميم متناسق مع الأزرار الموجودة (لون ذهبي مميز)
- [x] استخدام أيقونة Store للكاشير
- [x] التوجيه إلى /pos/login عند النقر
- [x] اختبار التنقل والتصميم (979 اختبار ناجح)


## واجهة التأكيد اليومي في تقرير الكاشير (مكتمل)
- [x] إنشاء مكون DailyConfirmationDialog
- [x] رفع صورة الموازنة (إجباري) مع معاينة وضغط
- [x] قسم فواتير المدفوع (اختياري) مع اختيار العميل (سالم الوادعي، عمر المطيري، سعود الجريسي)
- [x] قسم فواتير الولاء مع قيمة الخصم وعدد الفواتير
- [x] زر التأكيد في صفحة تقرير اليوم (أخضر مميز)
- [x] عرض حالة التأكيد (مؤكد/غير مؤكد)
- [x] API رفع الصور uploadBalanceImage
- [x] 979 اختبار ناجح


## إصلاح الطباعة الحرارية والتاريخ وعلامة المطابقة (مكتمل)
- [x] إصلاح الطباعة الحرارية 80mm (تصميم أبيض وأسود متوافق مع الطابعات الحرارية)
- [x] تغيير التاريخ من الهجري للميلادي (POS.tsx و POSDailyReport.tsx)
- [x] تصميم فاتورة حرارية احترافية مع أزرار طباعة/إغلاق
- [x] إضافة عمود "الكاشير" في جدول الإيرادات (مؤكد/بانتظار)
- [x] إضافة حقول posConfirmed, posConfirmedAt, posConfirmedBy لجدول dailyRevenues
- [x] 979 اختبار ناجح


## تصدير تقرير الإيرادات اليومي إلى Excel (مكتمل)
- [x] إنشاء API لتصدير الإيرادات إلى Excel (/api/revenues/export-excel)
- [x] تنسيق احترافي مع عنوان ونطاق تاريخ
- [x] أعمدة: التاريخ، اليوم، نقدي، شبكة، رصيد، فواتير مدفوع، ولاء، الإجمالي، الحالة، الكاشير
- [x] إضافة زر تصدير Excel أخضر بجانب زر PDF
- [x] تنسيق الأرقام وتلوين الصفوف بالتناوب
- [x] 979 اختبار ناجح


## تحسين شامل لنظام الفواتير والطباعة الحرارية (طلب جديد)

### 1. تحسين الفاتورة الحرارية
- [ ] إضافة شعار النظام في أعلى الفاتورة
- [ ] إضافة باركود للتحقق من الفاتورة (QR Code)
- [ ] إضافة جملة ترحيبية ختامية احترافية
- [ ] تحسين تنسيق الجدول وعرض الخدمات
- [ ] ضمان التوافق مع طابعات 80mm الحرارية
- [ ] إضافة رقم الهاتف وعنوان الفرع

### 2. تحسين واجهة الكاشير
- [ ] تحسين تصميم القائمة والأقسام
- [ ] تحسين تنسيق السلة وعرض العناصر
- [ ] تحسين أزرار الدفع والتحكم
- [ ] تحسين عرض معلومات عميل الولاء

### 3. صلاحيات الأدمن للفواتير
- [ ] تمكين الأدمن فقط من حذف الفواتير
- [ ] تمكين الأدمن فقط من تعديل الفواتير
- [ ] إضافة API endpoints محمية للحذف/التعديل
- [ ] إضافة تأكيد قبل الحذف

### 4. ربط الولاء والإيرادات
- [ ] تأكيد ربط فواتير الكاشير مع برنامج الولاء
- [ ] تأكيد ربط فواتير الكاشير مع الإيرادات اليومية
- [ ] تحديث حقل posConfirmed عند التأكيد
- [ ] اختبارات vitest للتحقق من الربط


## تحسين شامل لنظام الفواتير والطباعة الحرارية (مكتمل)
- [x] تحسين الفاتورة الحرارية مع الشعار وجملة ترحيبية "شكراً لزيارتكم - نتشرف بخدمتكم دائماً"
- [x] إضافة باركود QR للتحقق من الفاتورة (يحتوي على رقم الفاتورة والمبلغ والتاريخ والفرع)
- [x] ضمان توافق الطباعة مع طابعات 80mm (@page size: 80mm auto)
- [x] تحسين تصميم الفاتورة (شعار، هاتف، جدول خدمات، عميل ولاء)
- [x] تمكين الأدمن فقط من حذف/تعديل الفواتير (adminProcedure)
- [x] تأكيد الربط مع برنامج الولاء (loyaltyCustomerId) والإيرادات (revenueId)
- [x] 979 اختبار ناجح


## قائمة موظفي الفرع ورسالة الترحيب (مكتمل)
- [x] إنشاء قائمة جانبية لعرض موظفي الفرع (280px قابلة للإخفاء)
- [x] ترتيب الموظفين حسب إيراداتهم الشهرية (ذهبي/فضي/برونزي)
- [x] فلتر حسب الشهر والسنة (2024-2026)
- [x] رسالة ترحيب "هلا [اسم المشرف]" مع صورته
- [x] عرض صورة الموظف وعدد الفواتير والإيرادات
- [x] API rankingByRevenue لجلب ترتيب الموظفين
- [x] 979 اختبار ناجح


## نسبة التغيير في إيرادات الموظفين (مكتمل)
- [x] تعديل API rankingByRevenue لحساب نسبة التغيير مقارنة بالشهر السابق
- [x] عرض نسبة التغيير (↑ أخضر / ↓ أحمر) بجانب إيرادات كل موظف
- [x] إضافة أيقونات TrendingUp/TrendingDown
- [x] 979 اختبار ناجح


## إضافة خدمات الصالون وأسعارها (مكتمل)

### الخدمات المضافة (7 أقسام، 47 خدمة):
- [x] قسم الحلاقة: 9 خدمات (حلاقة رأس ودقن، رأس، دقن، شنب، أطفال، فرنسي، صفر، سكن فيد، موس)
- [x] قسم التنظيف: 7 خدمات (بشرة، عميق، بخار، أذن، أنف، ماسك أسود، ماسك ذهبي)
- [x] قسم الصبغات: 6 خدمات (شعر، دقن، ميش، سحب لون، تونر، جذور)
- [x] قسم العلاجات: 7 خدمات (كيراتين، بروتين، حمام زيت، ماسك، بوتكس، فيتامين، فروة)
- [x] قسم الحمام المغربي: 5 خدمات (كامل، تقشير، صابون، لف، بخار)
- [x] قسم المساج: 6 خدمات (كامل، ظهر، رأس، قدم، رقبة، تايلندي)
- [x] قسم الإضافات: 7 خدمات (شمع أذن/أنف/وجه، تشقير، تحديد، فوطة، أفتر شيف)

### التنفيذ:
- [x] إضافة الأقسام والخدمات لقاعدة البيانات (seed-pos-services.mjs)
- [x] API إدارة الخدمات موجود (pos.services.update, pos.services.create, pos.services.delete)
- [x] API إدارة الأقسام موجود (pos.categories.update, pos.categories.create, pos.categories.delete)
- [x] 979 اختبار ناجح


## واجهة إدارة الخدمات وصورة محمد إسماعيل (طلب جديد)
- [ ] إنشاء صفحة إدارة الخدمات في لوحة التحكم
  - [ ] عرض جميع الأقسام والخدمات
  - [ ] تعديل اسم وسعر كل خدمة
  - [ ] إضافة/حذف خدمات (للأدمن فقط)
  - [ ] تفعيل/إلغاء تفعيل الخدمات
- [ ] إضافة صورة محمد إسماعيل
  - [ ] رسالة ترحيب "مرحباً محمد إسماعيل"
  - [ ] صورة مصغرة في header الكاشير
- [ ] اختبارات vitest


## إدارة خدمات الكاشير وتحسين واجهة POS (طلب جديد)

### صفحة إدارة خدمات الكاشير
- [x] إنشاء صفحة POSServicesManagement.tsx
- [x] إضافة Route في App.tsx (/pos/services-management)
- [x] إضافة الصفحة في القائمة الجانبية (للأدمن فقط)
- [x] إدارة الأقسام (إضافة، تعديل، حذف)
- [x] إدارة الخدمات (إضافة، تعديل، حذف)
- [x] فلترة الخدمات حسب القسم
- [x] بحث في الخدمات
- [x] إحصائيات (عدد الأقسام والخدمات النشطة)

### تحسين واجهة الكاشير (POS)
- [x] إضافة حقل photoUrl في دالة getEmployeesByBranchForPos
- [x] عرض صورة الموظف المحدد بجانب اختيار الموظف
- [x] عرض صور الموظفين في قائمة الاختيار

### الاختبارات
- [x] اختبارات إدارة الأقسام (إنشاء، تحديث)
- [x] اختبارات إدارة الخدمات (إنشاء، تحديث، حذف)
- [x] اختبار جلب photoUrl للموظفين
- [x] جميع الاختبارات ناجحة (988 اختبار)



## تقارير أداء الخدمات الشهرية (طلب جديد)

### API وقاعدة البيانات
- [x] إنشاء دالة لجلب إحصائيات الخدمات الأكثر طلباً
- [x] إنشاء دالة لحساب إيرادات كل خدمة
- [x] إنشاء إجراء tRPC لتقرير أداء الخدمات

### صفحة التقرير
- [x] إنشاء صفحة تقرير أداء الخدمات (ServicePerformanceReport.tsx)
- [x] عرض الخدمات الأكثر طلباً مع عدد الطلبات
- [x] عرض إيرادات كل خدمة
- [x] رسم بياني للخدمات الأكثر طلباً
- [x] فلترة حسب الفرع والفترة الزمنية

### تصدير PDF
- [x] إنشاء قالب PDF احترافي للتقرير
- [x] تضمين الشعار والختم والتوقيعات
- [x] تصدير التقرير بتنسيق احترافي

### الاختبارات
- [x] اختبارات دوال قاعدة البيانات
- [x] اختبارات إجراءات tRPC


## تقرير أداء الموظفين (طلب جديد)

### API وقاعدة البيانات
- [x] إنشاء دالة لجلب إحصائيات أداء الموظفين من فواتير الكاشير
- [x] إنشاء دالة لحساب الخدمات المقدمة لكل موظف
- [x] إنشاء دالة لترتيب الموظفين حسب الإيرادات
- [x] إنشاء إجراءات tRPC لتقرير أداء الموظفين

### صفحة التقرير
- [x] إنشاء صفحة تقرير أداء الموظفين (EmployeePerformanceReport.tsx)
- [x] عرض ترتيب الموظفين حسب الإيرادات
- [x] عرض عدد الخدمات المقدمة لكل موظف
- [x] عرض متوسط قيمة الفاتورة لكل موظف
- [x] فلترة حسب الفرع والفترة الزمنية
...
## تحسين القوائم والواجهة الأمامية (طلب جديد)

### تحليل وتخطيط
- [x] تحليل DashboardLayout الحالي
- [x] تحديد نقاط الضعف في الأحجام والحركات
- [x] مراجعة أفضل الممارسات للقوائم الجانبية

### تحسين الأحجام
- [x] تحسين أحجام عناصر القائمة الجانبية
- [x] تحسين المسافات والتباعد (spacing)
- [x] تحسين أحجام الأيقونات والنصوص
- [x] تحسين عرض القائمة المفتوحة والمغلقة

### تحسين الحركات والانتقالات
- [x] إضافة انتقالات سلسة للقوائم الفرعية
- [x] تحسين حركة فتح/إغلاق القائمة الجانبية
- [x] إضافة تأثيرات hover احترافية
- [x] تحسين حركة التمرير (scroll)

### تحسين السلاسة والأداء
- [x] استخدام CSS transforms بدلاً من properties مكلفة
- [x] تحسين will-change للعناصر المتحركة
- [x] تقليل repaints و reflows
- [x] تحسين GPU acceleration

### الاختبار والتحقق
- [x] اختبار الأداء على الأجهزة المختلفة
- [x] التحقق من سلاسة الحركات


## تحسين واجهة بوابة الكاشير - Deep Thinking Framework (طلب جديد)

### المرحلة 1: الفهم العميق
- [x] تحليل مشاكل التنسيق في الهيدر
- [x] تحليل مشاكل الأحجام في التبويبات
- [x] تحليل مشاكل الحدود في بطاقات الخدمات
- [x] تحليل مشاكل سلة المشتريات

### المرحلة 2: التصميم المعماري
- [x] تحديد نظام التباعد الموحد (8px grid)
- [x] تحديد نظام الألوان والحدود
- [x] تحديد أحجام العناصر المثالية

### المرحلة 3: تحسين الهيدر والتبويبات
- [x] تحسين تباعد عناصر الهيدر
- [x] تحسين أحجام التبويبات
- [x] تحسين الحدود والظلال

### المرحلة 4: تحسين بطاقات الخدمات
- [x] توحيد أحجام البطاقات
- [x] تحسين التباعد الداخلي
- [x] تحسين الحدود والزوايا

### المرحلة 5: تحسين سلة المشتريات
- [x] تحسين تنسيق السلة
- [x] تحسين أحجام الأزرار
- [x] تحسين عرض الإجمالي


## تحسين صفحة إدارة خدمات الكاشير - Production Ready (طلب جديد)

### إصلاح الأخطاء
- [ ] إصلاح مشكلة حذف الأقسام (الأزرار لا تعمل)
- [ ] التحقق من جميع الوظائف (إضافة، تعديل، حذف)

### فصل الصفحات
- [ ] إنشاء صفحة إحصائيات الموظفين منفصلة
- [ ] إنشاء صفحة إدارة الأقسام منفصلة
- [ ] إنشاء صفحة إدارة الخدمات منفصلة
- [ ] إضافة الصفحات في القائمة الجانبية

### تحسين التصميم
- [ ] إضافة اللوجو في الصفحات
- [ ] تحسين الخط والتناسق
...
## إصلاح البيانات غير الدقيقة في إحصائيات الموظفين (طلب جديد)

### المرحلة 1: الفهم العميق
- [ ] تحليل الصورة المرفقة وتحديد المشكلة (كل الموظفين لديهم 43 فاتورة!)
- [ ] فحص استعلامات قاعدة البيانات الحالية
- [ ] فحص بنية جدول الفواتير وعلاقته بالموظفين
- [ ] التحقق من البيانات الفعلية في قاعدة البيانات

### المرحلة 2: التصميم المعماري
- [ ] تحديد مصدر المشكلة (استعلام أم بيانات)
- [ ] تصميم الحل الصحيح للاستعلامات
- [ ] التأكد من ربط الفواتير بالموظف الصحيح
...
- [ ] مقارنة البيانات مع قاعدة البيانات الفعلية


## إصلاح طباعة الفاتورة وصلاحيات المشرفين (طلب جديد)

### تحليل المشكلة
- [x] فهم مسار الطباعة الحالي (الطباعة تتم عبر window.open من الواجهة)
- [x] تحديد سبب طلب OAuth (الطباعة لا تحتاج OAuth - تتم من الواجهة)

### إصلاح مسار الطباعة
- [x] الطباعة تعمل بدون OAuth (عبر window.open من الواجهة)
- [x] المشرفين يمكنهم الطباعة مباشرة (لا تحتاج صلاحيات خاصة)

### صلاحيات المشرفين
- [x] إضافة صلاحية تعديل أسماء الموظفين للمشرفين (supervisorEditProcedure)
- [x] إضافة صلاحية تعديل أسعار الخدمات للمشرفين
- [x] التحقق من الصلاحيات في الـ API
- [x] إضافة endpoint لتحديث اسم الموظف في POS (pos.employees.updateName)

### الاختبار
- [x] اختبار صلاحيات المشرفين (23 اختبار ناجح)
- [x] اختبار تعديل الأسماء والأسعار


## تحسين وتسريع أداء النظام (طلب جديد) ✅

### المرحلة 1: تحليل وقياس الأداء الحالي
- [x] تحليل حجم Bundle الحالي (6.79 MB قبل التحسين)
- [x] قياس وقت استجابة API
- [x] تحليل استعلامات قاعدة البيانات البطيئة
- [x] فحص استخدام الذاكرة

### المرحلة 2: تحسينات قاعدة البيانات
- [x] إضافة 60+ Index للجداول الرئيسية
- [x] إضافة Composite Indexes للاستعلامات المركبة
- [x] تحسين استعلامات التقارير

### المرحلة 3: تحسينات Backend
- [x] إضافة Gzip Compression (level 6)
- [x] تحسين معالجة الأخطاء
- [x] تحسين Middleware

### المرحلة 4: تحسينات Frontend
- [x] Code Splitting للصفحات (Manual Chunks)
- [x] Lazy Loading لـ 70+ صفحة
- [x] تحسين Tree Shaking
- [x] تقليل حجم Bundle (من 6.79 MB إلى 447 KB = 93% تحسن)

### المرحلة 5: Caching ذكي
- [x] إضافة In-Memory Cache Service
- [x] Cache Keys للكيانات الرئيسية
- [x] TTL متغير حسب نوع البيانات
- [x] Pattern-based Cache Invalidation

### المرحلة 6: الاختبار والقياس النهائي
- [x] قياس التحسن في حجم Bundle (93% أصغر)
- [x] اختبار البناء (34.92s build time)


## تحسين نظام الكاشير POS (طلب جديد)

### المرحلة 1: فصل صفحة ترتيب الموظفين
- [ ] إنشاء صفحة منفصلة لترتيب الموظفين
- [ ] إضافة رابط في القائمة الجانبية
- [ ] نقل منطق الترتيب من الصفحة الرئيسية

### المرحلة 2: تحسين واجهة السلة ونافذة الدفع
- [ ] تصغير حجم السلة عند الدفع
- [ ] تحسين تصميم نافذة الدفع
- [ ] تحسين عرض العناصر في السلة

### المرحلة 3: تحسين أداء وسرعة الكاشير
- [ ] تحسين تحميل الخدمات
- [ ] تحسين تحميل الموظفين
- [ ] إضافة Memoization للمكونات
- [ ] تقليل Re-renders غير الضرورية

### المرحلة 4: تحسين طريقة العرض
- [ ] تحسين تصميم بطاقات الخدمات
- [ ] تحسين تصميم الفئات
- [ ] تحسين التخطيط العام

### المرحلة 5: التحقق من دقة البيانات
- [ ] التحقق من دقة بيانات الموظفين
- [ ] التحقق من دقة الإيرادات
- [ ] التحقق من دقة التقارير
- [ ] التحقق من ربط الولاء

### المرحلة 6: الاختبار والفحص
...
### فصل صفحة ترتيب الموظفين
- [x] إنشاء صفحة منفصلة لترتيب الموظفين (/pos-employee-ranking)
- [x] إضافة المسار في App.tsx
- [x] تصميم واجهة احترافية مع الإحصائيات

### تحسين واجهة السلة
- [x] تصغير عرض السلة من 380px إلى 320px
- [x] تصغير نافذة الدفع وتبسيطها
- [x] تحسين عرض عناصر السلة

### تحسين الأداء
- [x] إضافة useCallback للدوال الرئيسية
- [x] تحسين re-renders
- [x] شريط جانبي مصغر للموظفين (200px)

### التحقق من دقة البيانات
- [x] تحديث rankingByRevenue ليجلب من posInvoices مباشرة
- [x] التحقق من حسابات الإيرادات
- [x] التحقق من ربط الولاء (loyaltyCustomerId محفوظ)
- [x] التحقق من حسابات الخصومات

### الاختبارات
- [x] 10 اختبارات ناجحة لتحسينات POS
- [x] اختبار ترتيب الموظفين
...
## إصلاح باركود الولاء (طلب جديد) ✅

- [x] فحص مسارات الولاء الحالية في App.tsx (موجودة)
- [x] التحقق من وجود صفحات التسجيل وتسجيل الزيارة (موجودة)
- [x] المسارات تعمل في بيئة التطوير (/loyalty-register, /loyalty-visit)
- [x] اختبار التسجيل وتسجيل الزيارة (تعمل)
- [ ] ملاحظة: يحتاج إعادة نشر للموقع المنشور


## إصلاح 404 على الموقع المنشور (طلب جديد)

- [ ] فحص إعدادات SPA fallback
- [ ] التحقق من ملف _redirects أو vercel.json
- [ ] إصلاح routing للصفحات العامة
- [ ] اختبار على الموقع المنشور


## إصلاح مسارات الولاء للباركود (طلب جديد)

- [ ] إضافة مسار /loyalty/visit (الباركود يستخدم هذا المسار)
- [ ] إضافة مسار /loyalty/register
- [ ] اختبار المسارات الجديدة


## إصلاح مسارات الولاء للباركود (طلب جديد) ✅

- [x] إضافة مسار /loyalty/visit (الباركود يستخدم هذا المسار)
- [x] إضافة مسار /loyalty/register
- [x] اختبار المسارات الجديدة (تعمل بنجاح)


## تحسين واجهة ترتيب الموظفين (طلب جديد) ✅

- [x] تحليل الوضع الحالي لصفحة ترتيب الموظفين
- [x] تحسين تصميم الواجهة (منصة الفائزين، بطاقات ملخص ملونة، Progress bars)
- [x] تحسين الأداء (React.memo, useCallback, useMemo, staleTime)
- [x] إضافة زر الطباعة
- [x] اختبار الصفحة المحسنة


## إصلاح مشكلة 404 في باركود الولاء (طلب جديد - عاجل)

### المرحلة 1: الفهم العميق
- [ ] تحليل الرابط الذي يستخدمه الباركود بالضبط
- [ ] فحص المسارات المسجلة في App.tsx
- [ ] التحقق من إعدادات SPA fallback في السيرفر

### المرحلة 2: التصميم
- [ ] تحديد الفرق بين بيئة التطوير والموقع المنشور
- [ ] تصميم الحل الصحيح

### المرحلة 3: التنفيذ
- [ ] إصلاح المسارات
- [ ] التأكد من عمل SPA fallback
...
## منح صلاحية تعديل الخدمات لمشرف الفرع (طلب جديد)

- [ ] تحليل الصلاحيات الحالية للمشرف في الكاشير
- [ ] إضافة صلاحية تعديل الخدمات (الاسم والسعر)
- [x] اختبار الصلاحيات الجديدة (1086/1087 ناجح)


## منح صلاحية تعديل الخدمات لمشرف الفرع (طلب جديد - مكتمل)

### التحليل
- [x] تحليل الصلاحيات الحالية للمشرف في الكاشير
- [x] تحديد أن supervisorEditProcedure موجود في الـ Backend

### التنفيذ
- [x] تحديث POSServicesManagement.tsx لتشمل المشرفين (supervisor, manager)
- [x] تحديث POSServicesOnly.tsx لتشمل المشرفين
- [x] المشرف يمكنه: إضافة خدمة جديدة، تعديل الاسم والسعر
- [x] المشرف لا يمكنه: حذف الخدمات (للأدمن فقط)
- [x] المشرف لا يمكنه: إضافة أقسام جديدة (للأدمن فقط)

### الاختبارات
- [x] اختبار TypeScript (0 أخطاء)
- [x] اختبار الوحدات (1056 اختبار ناجح)


## فحص شامل لنظام الكاشير POS (Deep Thinking Framework)

### Phase 1: الفهم العميق
- [x] تحليل بنية ملفات الكاشير (15 ملف Frontend, 537 سطر Backend)
- [x] فهم تدفق البيانات (10 sub-routers)
- [x] تحديد المكونات الرئيسية

### Phase 2: فحص Backend
- [x] مراجعة APIs والـ endpoints (33 endpoint)
- [x] فحص الصلاحيات والأمان (Zod validation)
- [x] تحليل الأداء والاستعلامات

### Phase 3: فحص Frontend
- [x] مراجعة المكونات والواجهة (21 useState, 17 hooks)
- [x] فحص إدارة الحالة (tRPC + React hooks)
- [x] تحليل الأداء والتحميل

### Phase 4: فحص Database
- [x] مراجعة الجداول والعلاقات (6 جداول)
- [x] فحص الفهارس والأداء (10 indexes على posInvoices)
- [x] تحليل الاستعلامات (EXPLAIN)

### Phase 5: تحليل الأمان
- [x] فحص الصلاحيات (RBAC مطبق بشكل صحيح)
- [x] فحص التحقق من المدخلات (Zod)
- [x] فحص الحماية من الهجمات (TRPCError)

### Phase 6: تحليل الأداء
- [x] قياس أوقات الاستجابة (~50ms للفواتير)
- [x] تحليل حجم الحزم (POS.tsx = 64KB)
- [x] تحديد نقاط الاختناق (تكرار الكود)

### Phase 7: التقرير النهائي
- [x] إعداد تقرير الفحص الشامل (POS_AUDIT_REPORT.md)
- [x] قائمة التوصيات والتحسينات (9 توصيات)


## نظام خصم الزيارة الثالثة (كل 3 زيارات موافق عليها = خصم 60%)

### Phase 1: الفهم العميق ✅
- [x] تحليل جدول loyaltyVisits الحالي
- [x] فهم منطق الموافقة على الزيارات (status = 'approved')
- [x] تحليل تدفق البيانات بين الولاء والكاشير

### Phase 2: التصميم المعماري ✅
- [x] تصميم منطق حساب الخصم (كل 3 زيارات approved = 60%)
- [x] تصميم API للتحقق من استحقاق الخصم
- [x] تصميم واجهة القائمة المنسدلة في الكاشير

### Phase 3: Backend ✅
- [x] إضافة دالة getApprovedVisitsCount لحساب الزيارات الموافق عليها
- [x] إضافة دالة getEligibleLoyaltyCustomersForDiscount للقائمة المنسدلة
- [x] إضافة دالة checkLoyaltyDiscountByPhone للبحث السريع
- [x] إضافة 3 endpoints جديدة في pos.loyaltyCustomers router

### Phase 4: Frontend ✅
- [x] إضافة قائمة منسدلة للعملاء المؤهلين للخصم 60%
- [x] إضافة حاسبة الخصم (مؤهلين / زيارة واحدة للخصم / إجمالي)
- [x] تطبيق الخصم تلقائياً عند اختيار طريقة دفع "ولاء"
- [x] عرض معلومات الخصم للعميل المختار

### Phase 5: الاختبار ✅
- [x] اختبار منطق الخصم (8 اختبارات ناجحة)
- [x] اختبار TypeScript (بدون أخطاء)
- [x] جميع الاختبارات (1064 اختبار ناجح)


## إصلاح مشكلة 404 في بوابة الكاشير (طلب عاجل)

### Phase 1: الفهم العميق ✅
- [x] تحليل مسارات الكاشير في App.tsx (/pos-login, /pos)
- [x] فحص نقاط النهاية (auth.localLogin يعمل بشكل صحيح)
- [x] تتبع تدفق تسجيل الدخول (SPA fallback موجود)

### Phase 2: الإصلاح
- [x] تحديد سبب خطأ 404: الموقع المنشور يحتاج إعادة نشر (Publish)
- [x] الكود صحيح - المشكلة في النسخة المنشورة

## تحديث نظام دورة الولاء (30 يوم من الزيارة الأولى) ✅

### المتطلبات
- [x] كل عميل له دورة منفصلة 30 يوم من زيارته الأولى
- [x] بعد الزيارة الثالثة (خصم 60%) تبدأ دورة جديدة
- [x] إعادة تعيين عداد الزيارات بعد استخدام الخصم (startNewLoyaltyCycle)

### التنفيذ
- [x] تحديث getApprovedVisitsCount لاستخدام نظام الدورة (cycleInfo)
- [x] تحديث getEligibleLoyaltyCustomersForDiscount (محسّن للأداء)
...
## صلاحيات المشرف للخدمات وفصل بيانات الموظفين (طلب جديد - 2026-02-03)
- [x] إضافة صلاحية للمشرف لإضافة خدمات جديدة (تم تغيير create من adminProcedure إلى supervisorEditProcedure)
- [x] إضافة صلاحية للمشرف لتعديل الخدمات (كانت موجودة مسبقاً + إضافة تسجيل النشاط)
- [x] تحسين فصل بيانات الموظفين بين الفروع في التقارير (تم التحقق - الفصل موجود بالفعل)
- [x] ضمان عدم تداخل إيرادات الموظفين بين الفروع (تم تحسين getEmployeeRevenuesByDateRange)
- [x] اختبار الصلاحيات الجديدة (1086/1087 ناجح)

## تمكين حذف الطلبات الموافق عليها والسلف (طلب جديد - 2026-02-07)
- [x] تمكين الأدمن من حذف الطلبات الموافق عليها
- [x] تمكين الأدمن من حذف السلف
- [x] إضافة زر حذف في واجهة الطلبات والسلف

## إصلاح أخطاء برنامج الولاء (2026-02-12)
- [x] إصلاح خطأ تسجيل عميل جديد في برنامج الولاء
- [x] إصلاح خطأ تسجيل زيارة في برنامج الولاء
