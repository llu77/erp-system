...
- [x] إضافة صفحة الولاء للمشرفين في القائمة الجانبية
- [ ] تحديث قالب PDF لسند القبض ليطابق التصميم الحقيقي للتوقيعات والختم


## تحسين طباعة سندات القبض (طلب جديد)
- [x] تحديث قالب PDF لسند القبض ليطابق التصميم الحقيقي للتوقيعات والختم
- [x] قراءة صورة التوقيعات والختم من ملف خارجي (signatures-stamp.png)
- [x] تحسين حجم التوقيعات والختم في PDF

## تحسين PDF سند القبض بالصور الحقيقية (طلب جديد)
- [x] نسخ صور الختم والتوقيعات إلى مجلد المشروع
- [x] تحويل الصور إلى Base64 لتضمينها في PDF
- [x] تحديث قالب PDF لاستخدام الصور الحقيقية (3 صور منفصلة)
- [x] اختبار PDF والتحقق من ظهور الصور بشكل صحيح

## مراجعة شاملة لنظام الإشعارات والتنبيهات البريدية
- [ ] فحص بنية نظام الإشعارات والملفات الأساسية
- [ ] تحليل أنواع الإشعارات والتنبيهات المختلفة
- [ ] فحص آلية Triggers ونقاط الإطلاق
- [ ] تحليل نظام Queue والجدولة
- [ ] فحص قوالب البريد الإلكتروني
- [ ] إعداد تقرير تحليلي شامل مع التوصيات


## دمج نظام AI Agents المتقدم (طلب جديد)

### بنية النظام
- [x] إنشاء مجلد server/ai/agents للـ Agents
- [x] إنشاء خدمة Agent الأساسية (TypeScript)
- [x] إنشاء نظام الأدوات (Tools) للـ Agent
- [x] إنشاء أداة التفكير (Think Tool)
- [x] إنشاء نظام تنفيذ الكود (Code Execution)
- [x] إنشاء مدير الـ Prompts

### المساعدين المتخصصين
- [ ] مساعد هندسة AI (AI Engineering Expert)
- [ ] مساعد تنسيق الـ Agents (Orchestration)
- [ ] مساعد Python للأتمتة
- [ ] مساعد الدعم الفني (SysAdmin)
- [ ] مساعد تحليل الأداء
- [ ] مساعد البريد البارد (Cold Email)
- [ ] مساعد البحث عن CRM
- [ ] مساعد التطوير المهني

### واجهة المستخدم
- [x] صفحة إدارة الـ Agents
- [x] واجهة المحادثة مع الـ Agents
- [x] عرض سجل المحادثات
- [x] اختيار المساعد المناسب

### التكامل
- [x] دمج الـ Agents مع نظام الإشعارات
- [x] دمج مع تحليل البيانات
- [x] دمج مع التقارير الذكية
